...
$page_title = ' Admin Registerations';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors && $_POST['pass3'] == 0000 )) { // If everything's OK.
	
		// Register the user in the database...
		
		// Make the query:
		$q = "INSERT INTO admins (first_name, last_name, email, pass, registration_date) VALUES ('$fn', '$ln', '$e', SHA1('$p'), NOW() )";		
